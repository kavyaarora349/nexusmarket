...
import { LayoutGrid, PlusSquare, User, Shield, Activity, Zap } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 bg-brand-bg border-b border-brand-border">
        <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden xl:flex items-center gap-4 px-4 border-l border-brand-border">
