...
export const MARKET_FACTORY_ABI = [
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "enum PredictionMarket.ResolutionType",
        "name": "resolutionType",
        "type": "uint8"
      }
    ],
